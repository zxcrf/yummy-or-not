...
// Fusion Pixel CJK font-stack priority per lang (comma-separated family keys).
// This is platform-agnostic font-selection DATA — no DOM/CSS assumptions here.
// Consumed by the mobile font layer (expo-font per-locale selection) and, on
// web, by Tamagui/CSS. Values are the family keys SC/JP/KR (Simplified Chinese /
// Japanese / Korean) in display-priority order for each locale.
