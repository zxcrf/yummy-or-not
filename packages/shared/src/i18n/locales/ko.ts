...
export const ko: Record<string, string> = {
  nav_tastes: "기록", nav_recall: "추억", nav_saved: "저장", nav_you: "나", nav_stats: "통계", nav_todo: "먹고싶다", nav_nearby: "근처",
  recall_today: "오늘", recall_yesterday: "어제", recall_repurchase_badge: "또 샀어요", recall_empty: "아직 추억이 없어요.",
  my_tastes: "나의 입맛", count_logged: "{n}개 기록", search_log: "기록 검색…",
  count_todo: "{n}개 먹고싶다", search_todo: "먹고싶다 목록 검색…",
  log_taste: "맛 기록하기", edit_taste: "편집", recall_title: "전에 먹어봤나요?",
  ...
  add_photo: "사진 추가", photo_permission_denied: "사진을 선택하려면 사진 접근 권한이 필요합니다.", f_what: "무엇을 드셨나요?", f_what_todo: "무엇을 먹고 싶나요?", f_where: "어디서?", f_price: "가격",
  how_was_it: "어땠나요?", tags: "태그", add_tag: "태그 추가", tag_placeholder: "새 태그", your_take: "내 평가", save: "저장", save_taste: "이 맛 저장하기", save_taste_web: "저장",
  add_close_title: "임시 저장할까요?", add_close_body: "저장하지 않은 내용이 있어요. 임시 저장하고 나중에 이어서 할까요?", add_save_draft: "임시 저장", add_discard: "삭제",
  ...
  loc_pin_label: "핀 위치",
  loc_pin_set: "핀 설정됨",
  loc_pin_none: "정확한 위치 미설정",
  loc_pin_clear: "지우기",
  loc_pin_change: "핀 변경",
  loc_pick_on_map: "지도에서 선택",
  loc_picker_title: "위치 선택",
  loc_picker_confirm: "이 위치 사용",
  loc_picker_hint: "지도를 드래그하여 핀을 목표 지점에 맞추세요",
  loc_consent_title: "지도 및 개인정보",
  loc_consent_body: "이 기능은 AMap(高德) SDK로 정확한 위치를 선택합니다. 활성화하면 AMap 규정에 따라 지도 SDK가 초기화되며, 지도 서비스 제공을 위해 기기·네트워크 정보를 수집할 수 있습니다.",
  loc_consent_agree: "동의하고 켜기",
  ...
  taster_avatar_label: "아바타 URL (선택)",
  taster_delete_confirm: "이 테이스터를 삭제할까요? 기록은 더 이상 이 페르소나에 귀속되지 않습니다.",
  taster_empty: "아직 테이스터가 없습니다",
  taster_pro_required: "테이스터는 Pro 기능입니다. 업그레이드하면 가족과 파트너의 맛을 기록할 수 있어요.",
  taster_invalid_name: "이름은 1–50자여야 합니다",
  family_feed: "가족의 맛",
  family_feed_empty: "아직 공유된 가족의 맛이 없습니다",
