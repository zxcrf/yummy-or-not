...
export const es: Record<string, string> = {
  nav_tastes: "Sabores", nav_recall: "Recuerdos", nav_saved: "Guardado", nav_you: "Tú", nav_stats: "Datos", nav_todo: "Probar", nav_nearby: "Cerca",
  recall_today: "Hoy", recall_yesterday: "Ayer", recall_repurchase_badge: "De nuevo", recall_empty: "Aún no hay recuerdos.",
  ...
  log_taste: "Anota un sabor", edit_taste: "Editar", recall_title: "¿Ya lo probaste?",
  ...
  loc_pin_label: "Ubicación fijada",
  loc_pin_set: "Pin establecido",
  loc_pin_none: "Sin ubicación precisa",
  loc_pin_clear: "Borrar",
  loc_pin_change: "Cambiar pin",
  loc_pick_on_map: "Elegir en el mapa",
  loc_picker_title: "Elegir ubicación",
  loc_picker_confirm: "Usar este punto",
  loc_picker_hint: "Arrastra el mapa para centrar el pin en el lugar",
  loc_consent_title: "Mapa y privacidad",
  loc_consent_body: "Esto usa el SDK de AMap para elegir una ubicación precisa. Al activarlo se inicializa el SDK del mapa según las normas de cumplimiento de AMap, que puede recopilar información del dispositivo y la red para ofrecer servicios de mapas.",
  loc_consent_agree: "Aceptar y activar",
  ...
  taster_avatar_label: "URL de avatar (opcional)",
  taster_delete_confirm: "¿Eliminar este catador? Sus registros ya no se atribuirán a esta persona.",
  taster_empty: "Aún no hay catadores",
  taster_pro_required: "Catadores es una función Pro — actualiza para registrar gustos de familia y pareja.",
  taster_invalid_name: "El nombre debe tener entre 1 y 50 caracteres",
  family_feed: "Gustos familiares",
  family_feed_empty: "Aún no hay gustos familiares compartidos",
